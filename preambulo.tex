...
% original \usepackage[utf8]{inputenc}		% Codificacao do documento (conversão automática dos acentos)
...
\preambulo{Dissertação apresentada à Faculdade de Tecnologia da Universidade Estadual de Campinas como parte dos requisitos exigidos para a obtenção do título de Mestre em Tecnologia, na área de Ciências dos Materiais, Sistemas de Informação e Comunicação ou Ambiente.}
% --- 
